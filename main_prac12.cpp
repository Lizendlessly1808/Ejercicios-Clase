...
practica # 12
descripcion
en base al código mostrado en clase, en el que el carrito seguía una trayectoria al oprimir la tecla l
ahora con la tecla r, hará el mismo recorrido pero en reversa
manual de uso :
teclas
w: movimiento de la cámara hacia enfrente
s:movimiento de la cámara hacia atras
d:movimiento de la cámara hacia la derecha
a:movimiento de la cámara hacia la izquierda
l:movimiento del carrito hacia enfrente
r: movimiento del carrito en reversa
	*/
...
void animacion()
{
	...
	if (circuito) // comienza maquina
	{
		...
		//El que se modifica para que el auto vaya en diagonal
...
void keyboard ( unsigned char key, int x, int y )  // Create Keyboard Function
{
	switch ( key ) {
		...
		case 'I':
				...
				g_fanimacion = false;
				circuito2 ^= false; //Activamos/desactivamos la animacíon
		...
		case 'R':
			...
			g_fanimacion = false;
			circuito ^= false; //Activamos/desactivamos la animacíon
