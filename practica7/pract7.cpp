...
/*
	...
	Los planetas ya  cuentan con iluminación, brillo, material y con su propia orbita
...
GLfloat MercurioDiffuse[] = { 0.8f, 0.4f, 0.1f, 1.0f };			// mercurio
GLfloat MercurioSpecular[] = { 0.8, 0.8, 0.8, 1.0 };
GLfloat MercurioShininess[] = { 50.0 };



GLfloat VenusDiffuse[] = { 1.0f, 0.5f, 0.0f, 1.0f };			// Venus
...

{
	...
	glPushMatrix();//orbita tierra
	glColor3f(1.0, 1.0, 0.9);
	glRotatef(90, 1, 0, 0);//rotacion
	glutWireTorus(0.03, 12.45, 12, 50);
	glPopMatrix();
	...
	glPushMatrix();//orbita marte
	glColor3f(1.0, 1.0, 0.9);
	glRotatef(90, 1, 0, 0);//rotacion
	glutWireTorus(0.03, 16.5, 12, 50);
	glPopMatrix();
	...
	glPushMatrix();//orbita jupiter
	glColor3f(1.0, 1.0, 0.9);
	glRotatef(90, 1, 0, 0);//rotacion
	glutWireTorus(0.03,24.3, 12, 50);
	glPopMatrix();
	...
	glPushMatrix();//orbita saturno
	glColor3f(1.0, 1.0, 0.9);
	glRotatef(90, 1, 0, 0);//rotacion
	glutWireTorus(0.03,35.45, 12, 50);
	glPopMatrix();
	...
	glPushMatrix();//orbita urano
	glColor3f(1.0, 1.0, 0.9);
	glRotatef(90, 1, 0, 0);//rotacion
	glutWireTorus(0.03,46, 12, 50);
	glPopMatrix();
	...
	glPushMatrix();//orbita neptuno
	glColor3f(1.0, 1.0, 0.9);
	glRotatef(90, 1, 0, 0);//rotacion
	glutWireTorus(0.03,52.3, 12, 50);
	glPopMatrix();
	...
	glMaterialfv(GL_FRONT, GL_DIFFUSE, NeptunoDiffuse);//para aplicar los materiales y funciona como glcolor
	glMaterialfv(GL_FRONT, GL_SPECULAR, NeptunoDiffuse);
	glMaterialfv(GL_FRONT, GL_SHININESS, NeptunoDiffuse);
...

{
...

	{
		...
		mercurio = (mercurio + 5) % 360; //velocidad de 5 y modulo de 360

		venus = (mercurio + 2) % 360;
