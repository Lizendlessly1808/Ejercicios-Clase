...
void InitGL ( GLvoid )     // Inicializamos parametros
{
	...
	t_Dado.BuildGLTexture();//Se indica que es una imágen
	t_Dado.ReleaseImage();//Indica que se ocupara como una imágen que se va a visualizar
	//fin
...
void display ( void )   // Creamos la funcion donde se dibuja
{
	...
	glTranslatef(pos_camX, pos_camY, pos_camZ);
		...
		glPushMatrix(); 
			...
			prisma(t_Dado.GLindex,1,1,1); //información de la textura: 
		glPopMatrix();
